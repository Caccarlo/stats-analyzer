...
function TeamLogo({ teamName, className = 'h-12 w-12' }: { teamName: string; className?: string }) {
  ...
  return (
    <span
      className={`${className} grid shrink-0 place-items-center rounded-full border border-border bg-bg text-xs font-semibold text-text-secondary`}
      aria-label={teamName}
    >
      {initials || '—'}
    </span>
  ...
  return (
    <section className="min-w-0 rounded-xl border border-border bg-surface/70 p-4" aria-labelledby={`average-${side}-title`}>
      <div className="mb-4 flex items-center gap-3">
          <TeamLogo teamName={teamName} className="h-9 w-9" />
          ...
          <>
            <section className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3" aria-label="Risultati principali">
              ...
              >
                <div className="flex items-center justify-between gap-4">
                  <div className="flex min-w-0 items-center gap-3">
                      <TeamLogo teamName={props.homeTeamName} />
                    <div className="min-w-0">
              ...
              >
                <div className="flex items-center justify-between gap-4">
                  <div className="flex min-w-0 items-center gap-3">
                      <TeamLogo teamName={props.awayTeamName} />
                    <div className="min-w-0">
